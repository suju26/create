	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		finish.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				edt.putString("ex1", i_c.getText().toString());
				edt.putString("ex2", f_p.getText().toString());
				edt.putString("ex3", p_d.getText().toString());
				edt.putString("ex4", i_f.getText().toString());
				edt.putString("ex5", c_g.getText().toString());
				edt.putString("ex6", l_t.getText().toString());
				edt.putString("ex7", t_p.getText().toString());


				//Storing for rep

				edt.putString("r1", i_c1.getText().toString());
				edt.putString("r2", f_p1.getText().toString());
				edt.putString("r3", p_d1.getText().toString());
				edt.putString("r4", i_f1.getText().toString());
				edt.putString("r5", c_g1.getText().toString());
				edt.putString("r6", l_t1.getText().toString());
				edt.putString("r7", t_p1.getText().toString());
